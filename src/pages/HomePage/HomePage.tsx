        ...
        <Grid container item sm={12} lg={11} justify='center' alignItems='center'>
          <Grid item sm={12} lg={6}>
            <div className='HomePageContainer'>
              <div className='issueSupportName'><b>Please create an issue on this project's <a href="https://github.com/ImBerkayKaplan/PlanningPoker/issues">GitHub Page</a> if you spot a bug and include as much information as possible, such as screenshots.</b></div>
